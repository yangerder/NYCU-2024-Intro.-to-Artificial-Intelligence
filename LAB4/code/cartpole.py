...
class Agent():
    ...
    def choose_action(self, state):
        ...
        choose an action at random or select the action accroding to highest Q-value
        for current state from qtable.the essilon is change 0.95 and 0.05
        """
    ...
    def learn(self, state, action, reward, next_state, done):
        ...
        # TODO
        """
        caculate the Q-value update Qtable,if it is done target = rewaed
        """
        if not done:
    ...
    def check_max_Q(self):
        ...
        # TODO
        """
        Dicretized initial state first.Return the max Q-value
        """
